<footer class="footer">
                ...
                <div class="footer-widget">
                  ...
                  <ul class="list-menu ul-footer-contact">
                    ...
                    <li>
                      ...
                      <a class="a-phone" href="tel:19006750">1900 6750</a>
                    </li>
                    <li>
                      <span>Email:</span>
                      <a href="mailto:finalwp@gmail.com">finalwp@gmail.com</a>
                    </li>
                    <li>
                      <span>Website:</span>
                      <a href="/"
              ...
              <div class="col-xs-12 col-sm-6 col-md-3 col-lg-3 col-mb">
                <div class="footer-widget">
                  ...
                  <ul class="list-menu">
                    <li>
                      <p>
                        Hiểu và đồng cảm trước những vấn đề mà bạn đang gặp
                        phải, Ant Construction ra đời mang nhiệm vụ và sứ mệnh
                        đơn giản đó là: Hiện thực hóa ước mơ sở hữu ngôi nhà
                        hoàn hảo của khách hàng, thổi hồn vào từng công trình
                        bằng kinh nghiệm, sự chuyên nghiệp của chúng tôi.
                      </p>
                    </li>
                  </ul>
                </div>
        ...
        <div class="container">
          <div class="inner clearfix">
            <div class="row">
              <div class="col-sm-12 text-center">
                <span
                  >© Bản quyền thuộc về <b>PNVers</b>
                  <span class="s480-f">|</span> Cung cấp bởi
                  <a
                    href="https://helpdesk.passerellesnumeriques.org/index.php"
                    title="PNVers"
                    target="_blank"
                    rel="nofollow"
                    >PNVers</a
          ...
          <div class="back-to-top">
            <svg
              ...
              style="enable-background: new 0 0 261.808 261.808"
              xml:space="preserve"
            >
              <path
                style="fill: #ffffff"
    ...
    <link
      rel="preload"
      as="script"
      href="../bizweb.dktcdn.net/assets/themes_support/api.jquery.js"
    />
    <script
      src="../bizweb.dktcdn.net/assets/themes_support/api.jquery.js"
          ...
          <div class="col-xl-6 col-xs-12">
            ...
            <div class="info clearfix">
              <div class="product-image margin-top-5">
                <img
                  alt="popup"
                  src="../bizweb.dktcdn.net/100/321/299/themes/670850/assets/logof96c.png?1664275285895"
              ...
              <div class="actions">
                <button class="btn btn-primary margin-top-5 btn-continue">
                  Tiếp tục mua hàng
                </button>
                <button
                  class="btn btn-gray margin-top-5"
    ...
    <script>
      window.Bizweb || (window.Bizweb = {}),
        (Bizweb.mediaDomainName = "../bizweb.dktcdn.net/index.html"),
          ...
          return (
            ...
            (a.prototype.initDropdown = function () {
              ...
              if (!b) {
                var c = this;
                setTimeout(function () {
                  c.selectVariantFromParams(a) ||
                    c.selectors[0].element.onchange(a);
                });
              }
            }),
      ...
      function addToCartSuccess(jqXHR, textStatus, errorThrown) {
        ...
        if (windowW > 768) {
          ...
          var $popupMobile =
            ...
            jqXHR["title"] +
            '"></div></div>' +
            '<div class="media-body"><div class="product-title">' +
            jqXHR["name"] +
            "</div>" +
            ...
            if ($(".cart_page_mobile>div").length == "0") {
              ...
              jQuery(
                '<div class="cart-empty">' +
                  ...
                  "</div>" +
                  "</div>"
              ).appendTo(".header-cart-content");
            }
            if ($(".cart-tbody>div").length == "0") {
              $(".bg-cart-page").remove();
              $(".bg-cart-page-mobile").remove();
              jQuery(
                '<div class="bg-cart-page" style="min-height: auto"><p>Không có sản phẩm nào trong giỏ hàng. Quay lại <a href="index.html">cửa hàng</a> để tiếp tục mua sắm.</p></div>'
              ).appendTo(".cart");
            }
            if ($(".cart-tbody>div").length == "0") {
              $(".bg-cart-page").remove();
                  ...
                  jQuery.each(value, function (i, item) {
                    ...
                    jQuery(
                      '<li class="item productid-' +
                        ...
                        "'); var qty" +
                        item.variant_id +
                        " = result.value; if( !isNaN( qty" +
                        item.variant_id +
                        " ) &amp;&amp; qty" +
                        item.variant_id +
                        ' &gt; 1 ) result.value--;return false;" class="reduced items-count btn-minus" ' +
                        buttonQty +
                        ' type="button">–</button><input type="text" maxlength="12" min="1" onchange="if(this.value == 0)this.value=1;" class="input-text number-sidebar qty' +
                        item.variant_id +
                        '" id="qty' +
                        item.variant_id +
              ...
              if (key === "items") {
                ...
                if (value.length) {
                  ...
                  jQuery.each(value, function (i, item) {
                    ...
                    var pageCartItem =
                      '<div class="row shopping-cart-item productid-' +
                      item.variant_id +
                      '">' +
                      ...
                      item.variant_id +
                      '">' +
                      "<button onClick=\"var result = document.getElementById('qtyItem" +
                      item.variant_id +
                      "'); var qtyItem" +
                      item.variant_id +
                      " = result.value; if( !isNaN( qtyItem" +
                      item.variant_id +
                      ...
                      '<input type="text" onchange="if(this.value == 0)this.value=1;" maxlength="12" min="1" class="form-control quantity-r2 quantity js-quantity-product input-text number-sidebar input_pop input_pop qtyItem' +
                      item.variant_id +
                      '" id="qtyItem' +
                      item.variant_id +
                      '" name="Lines" id="updates_' +
                  ...
                  jQuery(
                    '<p class="hidden-xs-down">Không có sản phẩm nào trong giỏ hàng. Quay lại <a href="/" style="color:;">cửa hàng</a> để tiếp tục mua sắm.</p>'
                  ).appendTo(table);
                ...
                if (value.length) {
                  jQuery.each(value, function (i, item) {
                    ...
                    var pageCartItem =
                      ...
                      item.title +
                      "</a></p>" +
                      '<p class="variant-title-popup">' +
                      item.variant_title +
                      "</span>" +
                      '<p class="item-remove"><a href="javascript:;" class="remove-item-cart" title="Xóa" data-id="' +
                      item.variant_id +
                      '"><i class="fa fa-close"></i> Bỏ sản phẩm</a></p><p class="addpass" style="color:#fff;">' +
                      item.variant_id +
                      "</p></div></div>" +
                      ...
                      "</span>" +
                      '</div></div><div style="width: 15%;" class="text-center"><input class="variantID" type="hidden" name="variantId" value="' +
                      item.variant_id +
                      '">' +
                      "<button onClick=\"var result = document.getElementById('qtyItem" +
                      item.variant_id +
                      ...
                      '<div style="width: 15%;" class="text-right"><span class="cart-price"> <span class="price">' +
                      Bizweb.formatMoney(
            ...
            jQuery.each(cart, function (key, value) {
              if (key === "items") {
                ...
                if (value.length) {
                  ...
                  jQuery.each(value, function (i, item) {
                    ...
                    jQuery(
                      '<div class="item-product item productid-' +
                        item.variant_id +
                        ' "><div class="item-product-cart-mobile"><a href="' +
                        item.url +
                        '">	<a class="product-images1" href=""  title="' +
                        item.name +
                        '"><img width="80" height="150" alt="" src="' +
                        src +
                        '" alt="' +
                        item.name +
                        '"></a></a></div>' +
                        ...
                        "'); var qtyMobile" +
                        item.variant_id +
                        " = result.value; if( !isNaN( qtyMobile" +
                        item.variant_id +
                        " ) &amp;&amp; qtyMobile" +
                        item.variant_id +
                  ...
                  jQuery(
                    '<div class="header-cart-price" style=""><div class="title-cart "><h3 class="text-xs-left">Tổng tiền</h3><a class="text-xs-right totals_price_mobile">' +
                      Bizweb.formatMoney(
                        cart.total_price,
                        "{{amount_no_decimals_with_comma_separator}}₫"
                      ) +
    ...
    <div id="popup-cart" class="modal fade" role="dialog">
      <div id="popup-cart-desktop" class="clearfix">
        <div class="title-popup-cart">
          <i class="ion ion-md-notifications-outline" aria-hidden="true"></i>
          ...
          <div class="tfoot-popup">
            <div class="tfoot-popup-1 clearfix">
              <div class="pull-left popupcon">
                <a
                  ...
                  ><span
                    ><span
                      ><i class="fa fa-caret-left" aria-hidden="true"></i> Tiếp
                      tục mua hàng</span
                    ></span
                  ></a
                >
            ...
            <div class="tfoot-popup-2 clearfix">
              <a
                ...
                href="cart.html"
                ><span>Thanh toán đơn hàng</span></a
              >
            </div>
          </div>
        </div>
    ...
    <link
      rel="preload"
      as="script"
      href="../bizweb.dktcdn.net/100/321/299/themes/670850/assets/counterup-minf96c.js?1664275285895"
    />
    <script
      src="../bizweb.dktcdn.net/100/321/299/themes/670850/assets/counterup-minf96c.js?1664275285895"
      type="text/javascript"
    ></script>
    <script>
    ...
    <link
      rel="preload"
      as="script"
      href="../bizweb.dktcdn.net/100/321/299/themes/670850/assets/mainf96c.js?1664275285895"
    />
    <script
      src="../bizweb.dktcdn.net/100/321/299/themes/670850/assets/mainf96c.js?1664275285895"
      type="text/javascript"
    ></script>
    ...
    <div class="mobile-main-menu">
      <div class="drawer-header">
        <a href="account/login.html">
          <div class="drawer-header--auth">
            <div class="_object">
              <img
                src="../bizweb.dktcdn.net/100/321/299/themes/670850/assets/userf96c.svg?1664275285895"
        ...
        <div class="la-nav-menu-items">
          ...
          <ul class="la-nav-list-items">
            ...
            <li class="ng-scope ng-has-child1">
              <a href="collections/all.html"
                >Sản phẩm <i class="fa fa-plus fa1" aria-hidden="true"></i
              ></a>
              <ul class="ul-has-child1">
                ...
                <li class="ng-scope">
                  <a href="kim-khi-bao-ho-lao-dong.html"
                    >Kim khí, bảo hộ lao động</a
                  >
                </li>
              </ul>
            </li>
            ...
            <li class="ng-scope ng-has-child1">
              <a href="tin-tuc.html"
                >Tin tức <i class="fa fa-plus fa1" aria-hidden="true"></i
              ></a>
              <ul class="ul-has-child1">
                <li class="ng-scope">
                ...
                <li class="ng-scope ng-has-child2">
                  <a href="tin-tuc.html"
                    >Tin tức <i class="fa fa-plus fa2" aria-hidden="true"></i
                  ></a>
      ...
      <ul class="mobile-support">
        ...
        <li>
          ...
          <a href="mailto:PNVers@gmail.com">PNVers@gmail.com</a>
        </li>
      </ul>
    </div>
    <link
