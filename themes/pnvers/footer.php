<footer>
        <div class="footer__container">
            ...
            <div class="footer--right">
                <a style="--bg-icon: #3b5998" href="https://www.facebook.com/Dennis0406" class="footer--right__item">
        ...
        <p class="footer__author">
            Design by <a href="https://www.facebook.com/Dennis0406" target="blank">Dennis © <?php echo date('Y'); ?>
            </a>
        </p>
</footer>
</div> <!-- end container -->
